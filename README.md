...
1. Download the latest release corresponding to your system,
   - ### 🪟 [Windows (x64) [Installer]](https://github.com/m4heshd/ufc-ripper/releases/download/v4.1.0/ufc-ripper_4.1.0_x64-setup.exe)
   - ### 🪟 [Windows (x64) [Portable]](https://github.com/m4heshd/ufc-ripper/releases/download/v4.1.0/ufc-ripper-v4.1.0-win32-x64.zip)
   - ### 🐧 [Linux (x64) [Portable]](https://github.com/m4heshd/ufc-ripper/releases/download/v4.1.0/ufc-ripper-v4.1.0-linux-x64.zip)
   - ### 🐧 [Linux (arm64) [Portable]](https://github.com/m4heshd/ufc-ripper/releases/download/v4.1.0/ufc-ripper-v4.1.0-linux-arm64.zip)
   - ### 🍎 [macOS (x64) [Portable]](https://github.com/m4heshd/ufc-ripper/releases/download/v4.1.0/ufc-ripper-v4.1.0-macos-x64.zip)
   - ### 🍎 [macOS (arm64) [Portable]](https://github.com/m4heshd/ufc-ripper/releases/download/v4.1.0/ufc-ripper-v4.1.0-macos-arm64.zip)
